...
public class Editar_Actividades extends javax.swing.JFrame {
    ...
    private void eliminar(){
        ...
        try {           
          ...
          //Sentencias SQL predefinidas
          String sqlEliminar = "DELETE FROM estudiantes where carnet='A12346';";
          String sqlMostrar = "SELECT * FROM estudiantes;";
      	
          stmt = con.createStatement(); //crea el objeto de la sentencia SQL
          int exito = stmt.executeUpdate(sqlEliminar); //elimina a los estudiantes
          				//exito contiene la cantidad de registros eliminados
          System.out.println("valor: " + exito);
          if (exito>0)
            {            	
            	rs = stmt.executeQuery(sqlMostrar); //muestra los estudiantes que quedaron.
            	displayRow("estudiantes", rs);
            }
            else System.out.print("No se encontr  el carnet a eliminar");
